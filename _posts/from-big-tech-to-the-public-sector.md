...
* Modernizing legacy civic infrastructure. There is nothing more frustrating to me than seeing a technically working but impossible-to-use UI on a government website - I can just _feel_ the hundreds of thousands of collective hours lost by people trying to fill it out, giving up, and calling the office (or not!) instead. Moreover, I have a theory that trust in government would increase if everyday civil services were easier to use - a theory that so far seems borne out by the [California DMV website](https://www.dmv.ca.gov/portal/dmv-virtual-office/accident-reporting/?utm_source=RSEDigital&utm_medium=PaidSearch&utm_campaign=DMV_Accident_Form&https://www.dmv.ca.gov/portal/dmv-virtual-office/accident-reporting/?utm_source=RSEDigital&utm_medium=PaidSearch&utm_campaign=DMV_Accident_Form&gclid=CjwKCAiAirb_BRBNEiwALHlnDzQE2JvnTuIS4fdEiXzz6GTY0TFn3tsiDzFIPFEmcJeZY-CITivOpRoCEfIQAvD_BwE) redesign. _(Side note - the official New Zealand Immigration webapp,_ [_NZ Ready_](https://nzready.immigration.govt.nz/)_, is a perfect example of how easy government services should be to use! We CAN have nice things, folks!)_
* Disaster response. Response has always been my civic engagement of choice - I keep my CPR/First Aid certification up to date, and was part of Google’s [CERT](https://www.ready.gov/cert#:\~:text=The%20Community%20Emergency%20Response%20Team,organization%2C%20and%20disaster%20medical%20operations.) group. Coupled with living through the devastation of a few wildfires in my home state of California, response is near and dear to my heart. It is also very tied into the first theme - there’s so much that can be done in modernizing disaster response communication and prevention systems.
...
* Another is with the [Information Technology Disaster Resource Center (ITDRC)](https://www.itdrc.org/), a non-profit that helps provide wifi and alternative communication methods to disaster shelters across the nation. I am helping to scope California fairgrounds and prep equipment kits for each.

### But now is the time to leave.

![](/images/logan-weaver-lhdqawgns_i-unsplash-1.jpg)

It’s coming up on a year now since I started with Android Auto and these two volunteer projects, and what a crazy year it’s been. Between COVID, ever-growing climate-related disasters, and general unrest across the nation, I feel the urge to serve stronger than ever. I have been eying either the [Presidential Innovation Fellows,](https://presidentialinnovationfellows.gov/) the [United States Digital Service](https://www.usds.gov/), or the [California Digital Services](https://www.alpha.ca.gov/office-of-digital-innovation/) as my next step. 